      ...
      <section className="mx-auto w-full max-w-md rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[var(--shadow-soft)]">
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm text-[var(--color-text-sub)]">
            Sign in to access your TutorFlow dashboard.
          </p>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<main className="py-16"><section className="mx-auto w-full max-w-md rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[var(--shadow-soft)]"><p className="text-center text-[var(--color-text-sub)]">Loading...</p></section></main>}>
      <LoginForm />
    </Suspense>
  );
}
